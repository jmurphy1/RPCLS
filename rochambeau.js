...
function displayMatchScore(playermatchesId, computermatchesId) {
    document.getElementById(playermatchesId).innerHTML = matchscore[0];
    document.getElementById(computermatchesId).innerHTML = matchscore[1];
}
